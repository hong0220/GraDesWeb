        ...
        $(document)
                ...
                function () {
                    ...
                    numTrendChart = new Highcharts.Chart({
                        ...
                        xAxis: {
                            categories: ['3月1号', '3月2号', '3月3号',
                                '3月4号', '3月5号', '3月6号', '3月7号',
                                '3月8号', '3月9号', '3月10号', '3月11号',
                                '3月12号','3月1号', '3月2号', '3月3号',
                                '3月4号', '3月5号', '3月6号', '3月7号',
                                '3月8号', '3月9号', '3月10号', '3月11号',
                                '3月12号']
                        },
                        ...
                        series: [
                            {
                                ...
                                data: [-0.9, 0.6, 3.5, 8.4,
                                    13.5, 17.0, 18.6, 17.9,
                                    14.3, 9.0, 3.9, 1.0,-0.9, 0.6, 3.5, 8.4,
                                    13.5, 17.0, 18.6, 17.9,
                                    14.3, 9.0, 3.9, 1.0]
                            },
                            {
                                ...
                                data: [3.9, 4.2, 5.7, 8.5,
                                    11.9, 15.2, 17.0, 16.6,
                                    14.2, 10.3, 6.6, 4.8,3.9, 4.2, 5.7, 8.5,
                                    11.9, 15.2, 17.0, 16.6,
                                    14.2, 10.3, 6.6, 4.8]
                            },
                            {
                                name: '中性情感的微博数量增量',
                                data: [4.9, 5.2, 6.7, 8.5,
                                    11.9, 15.2, 17.0, 9.6,
                                    3.2, 3.3, 6.6, 8.8,4.9, 5.2, 6.7, 8.5,
                                    11.9, 15.2, 17.0, 9.6,
                                    3.2, 3.3, 6.6, 8.8]
                            }]
                    });
